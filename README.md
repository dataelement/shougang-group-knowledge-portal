...
- `VITE_BISHENG_MINIO_PROXY_TARGET=http://192.168.106.171:9100`
- `BISHENG_MINIO_SIGNED_HOST=minio:9000`（须与 BiSheng 的 `BS_MINIO_SHAREPOINT` 一致，否则 MinIO 预签名 URL 会 403）
