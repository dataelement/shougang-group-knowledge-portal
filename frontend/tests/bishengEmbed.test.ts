...
test('knowledge embed URL receives portal deep-link space params', () => {
  const base = 'http://110.16.193.170:3002/workspace/knowledge-portal?portal_embed=1';
  const url = mergeKnowledgeDeepLinkParams(
    base,
    new URLSearchParams('spaceId=118'),
    portalLocation,
  );
  assert.equal(
    url,
    'http://110.16.193.170:3002/workspace/knowledge-portal?portal_embed=1&spaceId=118',
  );
});

test('knowledge embed URL receives portal deep-link folder params', () => {
  const base = 'http://110.16.193.170:3002/workspace/knowledge-portal?portal_embed=1';
  const url = mergeKnowledgeDeepLinkParams(
    base,
    new URLSearchParams('spaceId=118&folderId=200&folderName=%E5%88%B6%E5%BA%A6'),
    portalLocation,
  );
  assert.equal(
    url,
    'http://110.16.193.170:3002/workspace/knowledge-portal?portal_embed=1&spaceId=118&folderId=200&folderName=%E5%88%B6%E5%BA%A6',
  );
});
...
test('knowledge embed URL receives portal deep-link file params', () => {
  ...
  const url = mergeKnowledgeDeepLinkParams(
    base,
    new URLSearchParams('spaceId=118&folderId=200&fileId=345&fileName=doc.md'),
    portalLocation,
  );
  assert.equal(
    url,
    'http://110.16.193.170:3002/workspace/knowledge-portal?portal_embed=1&spaceId=118&folderId=200&fileId=345&fileName=doc.md',
  );
});
