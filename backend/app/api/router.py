...
from app.api.routes.portal_public_config import router as portal_public_config_router
...
api_router.include_router(portal_public_config_router)
api_router.include_router(knowledge_recycle_router)
